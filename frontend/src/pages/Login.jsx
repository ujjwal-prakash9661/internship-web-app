...
const Login = () => {
    ...
    const handleLogin = async(e) => {
        ...
        try {
            const response = await axios.post('https://internship-web-app-42i2.onrender.com/api/auth/login', {email, password});
    ...
    const handleGitHubLogin = () => {
        window.location.href = 'https://internship-web-app-42i2.onrender.com/api/auth/login/auth/github'
    }
